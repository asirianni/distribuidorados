...
<div class="row">
    <div class="col-xs-6">
        ...
        <div class="col-xs-8">
            <p><strong><?php echo $factura["proveedor_razon_social"]?></strong></p>
            <p><strong><?php echo $factura["proveedor_direccion"]." - ".$factura["proveedor_desc_localidad"]?></strong></p>
            <p><strong><?php echo $factura["proveedor_desc_provincia"]?></strong></p>
        </div>
    </div>
    <div class="col-xs-6">
        <div class="col-xs-4">
        ...
        <div class="col-xs-8">
            <p><?php echo $factura["proveedor_cuil"]?></p>
        </div>
        ...
        <div class="col-xs-7">
            <p><?php echo $factura["proveedor_ingresos_brutos"]?></p>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-xs-12 lineas">
        ...
        <div class="col-xs-6">
            I.V.A<strong> <?php echo $factura["desc_proveedor_tipo_de_inscripcion"]?></strong>
        </div>
    </div>
</div>
