                    ...
                    <div class="col-md-12" style="margin-top: 10px;">
                        <form action="<?php echo base_url()?>index.php/<?php echo $controller_usuario?>/reporte_de_venta" method="post" id="formulario_consultar_remito">
                            ...
                            <div class="col-md-4  col-sm-4">
                                <div class="form-group">
                                    <label for=""></label>
                                    <button  class="form-control btn btn-warning" onClick="$('#formulario_impresion').submit();return false;" ><i class="fa fa-print"></i> Imprimir</button>
                                </div>
                            </div>
                            <div class="col-md-4  col-sm-4">
                                <div class="form-group">
                                    <label for=""></label>
                                    <button  class="form-control btn btn-success" onclick="exportar_a_excel();return false;"><i class="fa fa-file-excel-o"></i> Exportar a Excel</button>
                                </div>
                            </div>
                        </form>
                    </div>
