...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Ver factura de compra N° <?php echo $factura["numero"]?>
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="proveedor_ver_factura">Proveedor: </label>
                                <input class="form-control" type="text" id="proveedor_ver_factura" value="<?php echo $factura["proveedor_cuil"]." - ".$factura["proveedor_razon_social"]?>"  disabled/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
