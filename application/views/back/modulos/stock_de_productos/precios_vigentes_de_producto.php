        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    <button class="btn btn-danger" onClick="$('#modal_agregar_precio_vigente').modal('show');"><i class='fa fa-plus'></i>  Agregar Precio</button>
                    <a href="<?php echo base_url()?>index.php/<?php echo $controller_usuario?>/stock_de_productos_listado" class="btn btn-danger pull-right"><i class='fa fa-arrow-left'></i> Volver al Listado</a>
                </div><!-- /.box-header -->
                <div class="box-body">
...
<div class="modal modal-danger" id="modal_agregar_precio_vigente">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="col-md-12" style="text-align: center;">
                    <button class="btn btn-danger" onClick="agregar_precio()"><i class='fa fa-save'></i> Guardar Precio</button>
                </div>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
...
<div class="modal modal-danger" id="modal_editar_precio_vigente">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            ...
            <div class="modal-footer">
                <div class="col-md-12" style="text-align: center;">
                    <button class="btn btn-danger" onClick="editar_precio()"><i class='fa fa-save'></i> Guardar Cambios</button>
                </div>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
