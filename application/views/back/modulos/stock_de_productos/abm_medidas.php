            ...
            <div class="box">
                ...
                <div class="box-body">
                  <table id="tabla_listado" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <?php
                            foreach($listado_unidades_de_medidas as $value)
                            {
                                echo 
                                "<tr>
                                    <td>".$value["id"]."</td>
                                    ...
                                    <td>".$value["medida"]."</td>
                                    <td>
                                        <button class='btn btn-success' data-toggle='tooltip' title='' data-original-title='Editar' onClick='abrir_modal_editar_unidad_de_medida(".$value["id"].",&#34;".$value["descripcion"]."&#34;,".$value["cantidad"].",&#34;".$value["medida"]."&#34;)'><i class='fa fa-edit'></i></button>
