        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    <button class="btn btn-warning" onClick="$('#modal_agregar_rubro').modal('show');"><i class='fa fa-plus'></i> Agregar Rubro</button>
                </div><!-- /.box-header -->
                <div class="box-body">
                        ...
                        <?php
                            foreach($listado_rubros as $value)
                            {
                                ...
                                "<tr>
                                    ...
                                    <td>
                                        <button class='btn btn-success' data-toggle='tooltip' title='' data-original-title='Editar' onClick='abrir_modal_editar_rubro(".$value["id"].",&#34;".$value["descripcion"]."&#34;)'><i class='fa fa-edit'></i></button>
                                        <!--<button class='btn btn-danger' data-toggle='tooltip' title='' data-original-title='Eliminar' onClick='abrir_modal_eliminar_precio_vigente(".$value["id"].")'>X</button>-->
                                    </td>    
                                </tr>";
                            }
                        ?>  
...
<!---->
<div class="modal modal-warning" id="modal_editar_rubro">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="text" id="id_rubro_para_editar" hidden="true"/>
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="descripcion_editar_rubro">Descripcion: </label>
                        <input class="form-control" type="text" id="descripcion_editar_rubro" name="descripcion_editar_rubro" value=""/>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                <div class="col-md-12" style="text-align: center;">
                    <button class="btn btn-warning" onClick="editar_rubro()"><i class='fa fa-save'></i> Guardar Cambios</button>
                </div>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
...
<div class="modal modal-warning" id="modal_agregar_rubro">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            ...
            <div class="modal-body">
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="descripcion_agregar_rubro">Rubro: </label>
                        <input class="form-control" type="text" id="descripcion_agregar_rubro" name="descripcion_agregar_rubro" value=""/>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                <div class="col-md-12" style="text-align: center;">
                    <button class="btn btn-warning" onClick="agregar_rubro()"><i class='fa fa-save'></i> Guardar Rubro</button>
                </div>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
...
<script>
    ...
    function abrir_modal_editar_rubro(id,descripcion)
    {
        $("#id_rubro_para_editar").val(id);
        $("#descripcion_editar_rubro").val(descripcion);
        $("#modal_editar_rubro").modal("show");
    }
    
    function editar_rubro()
    {
        var id= $("#id_rubro_para_editar").val();
        var descripcion= $("#descripcion_editar_rubro").val();
        
        if(descripcion != "" && !isNaN(id))
        {
            $.ajax({
                url: "<?php echo base_url()?>index.php/Response_Ajax/editar_rubro",
                type: "POST",
                data:{id_rubro:id,descripcion:descripcion},
                success: function(data)
                {
                    ...
                    if(data > 0)
                    {
                        location.href="<?php echo base_url()?>index.php/<?php echo $controller_usuario?>/stock_de_productos_rubros";
                    }
                    else
                    {
    ...
    function gestiona_errores_editar()
    {
        ...
        if(descripcion==""){activar_error("descripcion_editar_rubro");}
        else{desactivar_error("descripcion_editar_rubro");}
    }
    
    function agregar_rubro()
    {
        var descripcion= $("#descripcion_agregar_rubro").val();
        
        if(descripcion != "")
        {
            $.ajax({
                url: "<?php echo base_url()?>index.php/Response_Ajax/agregar_rubro",
                type: "POST",
    ...
    function gestiona_errores_agregar()
    {
        ...
        if(descripcion==""){activar_error("descripcion_agregar_rubro");}
        else{desactivar_error("descripcion_agregar_rubro");}
    }
