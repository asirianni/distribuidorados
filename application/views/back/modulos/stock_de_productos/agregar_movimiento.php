        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    <a href="<?php echo base_url()?>index.php/<?php echo $controller_usuario?>/stock_de_productos_movimientos" class="btn btn-danger pull-right" ><i class='fa fa-arrow-left'></i> Volver al Listado</a>
                </div><!-- /.box-header -->
                <div class="box-body">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-12" style="text-align: center;">
                        <button class="btn btn-danger" onClick="procesar()">Procesar</button>
                    </div>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
         </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="col-md-12" style="text-align: center;">
                    <button class="btn btn-danger" onClick="agregar_cantidad_producto()">Agregar Cantidad</button>
                </div>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
