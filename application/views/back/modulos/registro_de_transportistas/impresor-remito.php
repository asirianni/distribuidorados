...
<div class="row">
    ...
    <div class="col-xs-5">
        <p><strong>N° <?php echo $remito["numero"]?></strong></p>
        <p><strong>FECHA <?php $date = date_create($remito["fecha"]);
                            echo date_format($date, 'd-m-Y');?></strong></p>
        <p style="font-size: 22px;"><strong>REMITO</strong></p>
    </div> 
...
<div class="row">
    <div class="col-xs-12 lineas">
        <div class="col-xs-offset-1 col-xs-5">
            CONDICION DE VENTA: <?php echo $remito["condicion_de_venta_condicion"]?>
        </div>
        <div class="col-xs-6">
            I.V.A<strong> RESP. INSCRIP</strong>
        </div>
    </div>
</div>
...
<?php
    $total_remito = 0;
    foreach ($detalle_remito as $value)
    {
...
<div class="row">
    <div class="col-xs-offset-2 col-xs-10">
        <p>TRANSPORTE: <?php echo $remito["transporte_transporte"]?></p>
        <p>Cuit: <?php echo $remito["transporte_cuit"]?></p>
        <p>Chofer: <?php echo $remito["chofer_nombre"]." ".$remito["chofer_apellido"]?></p>
        <p>Cuil: <?php echo $remito["chofer_cuit"]?></p>
        <p>Chasis: <?php echo $remito["chasis"]?></p>
        <p>Aclop.: <?php echo $remito["acoplado"]?></p>
        <p>LUGAR DE ENTREGA: <?php echo $remito["entrega"]?></p> 
    </div>
</div>

<div class="row">
    <div class="col-xs-offset-8 col-xs-4">
        <p>TOTAL: $<?php echo $total_remito?></p>
    </div>
</div>
