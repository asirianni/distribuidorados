        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    <a href="<?php echo base_url()?>index.php/<?php echo $controller_usuario?>/registro_de_pedidos_agregar" class="btn btn-warning" ><i class='fa fa-plus'></i> Agregar Pedido</a>
                </div><!-- /.box-header -->
                <div class="box-body">
...
<div class="modal modal-warning" id="modal_agregar_pedido">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="col-md-12" style="text-align: center;">
                    <button class="btn btn-warning" onClick="agregar_pedido()">Guardar Pedido</button>
                </div>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
...
<div class="modal modal-warning" id="modal_editar_pedido">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            ...
            <div class="modal-footer">
                <div class="col-md-12" style="text-align: center;">
                    <button class="btn btn-warning" onClick="editar_pedido()">Guardar Pedido</button>
                </div>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
