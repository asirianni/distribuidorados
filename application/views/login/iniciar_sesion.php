...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?php echo base_url()?>index.php/Login"><strong>Nutrilog S.R.L</strong></a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            ...
            <p class="login-box-msg">Ingrese para acceder al panel</p>
