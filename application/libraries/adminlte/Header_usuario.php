...
class Header_usuario
{
    ...
    public static function getHeader($tipo_usuario,$nombre,$apellido,$fecha_registro,$foto_perfil)
    {
        ...
        switch($tipo_usuario)
        {
            case 1: $html= Header_usuario::getHeaderAdministrador($nombre,$apellido,$fecha_registro,$foto_perfil);
                break;
            case 2: $html= Header_usuario::getHeaderVendedor($nombre,$apellido,$fecha_registro,$foto_perfil);
                break;
            case 3: $html= Header_usuario::getHeaderContador($nombre,$apellido,$fecha_registro,$foto_perfil);
                break;
            case 4: $html= Header_usuario::getHeaderTransportista($nombre,$apellido,$fecha_registro,$foto_perfil);
                break;
        }
                ...
                $html.="<span class='hidden-xs'>".$nombre." ".$apellido."</span>
                    ...
                    else
                    {
                      ...
                      <li class='user-footer'>
                        <div class='pull-left'>
                          <a href='".base_url()."index.php/Administrador/mi_perfil' class='btn btn-default btn-flat'>Perfil</a>
                        </div>
    ...
    public static function getHeaderVendedor($nombre,$apellido,$fecha_registro,$foto_perfil)
    {
        $html=
        "
          <header class='main-header'>
              ...
              <div class='navbar-custom-menu'>
                ...
                $html.="<span class='hidden-xs'>".$nombre." ".$apellido."</span>
                    ...
                    else
                    {
                      ...
                      <li class='user-footer'>
                        <div class='pull-left'>
                          <a href='".base_url()."index.php/Vendedor/mi_perfil' class='btn btn-default btn-flat'>Perfil</a>
                        </div>
                        <div class='pull-right'>
                          <a href='".base_url()."index.php/Login' class='btn btn-default btn-flat'>Cerrar Sesion</a>
                        </div>
    ...
    public static function getHeaderContador($nombre,$apellido,$fecha_registro,$foto_perfil)
    {
        $html=
        "
          <header class='main-header'>
            <!-- Logo -->
            <a href='".base_url()."index.php/Contador/index' class='logo'>
              <!-- mini logo for sidebar mini 50x50 pixels -->
              <span class='logo-mini'>ADM</span>
              <!-- logo for regular state and mobile devices -->
              <span class='logo-lg'>".Header_usuario::$texto_header."</span>
              ...
              <div class='navbar-custom-menu'>
                ...
                $html.="<span class='hidden-xs'>".$nombre." ".$apellido."</span>
                    ...
                    else
                    {
                      ...
                      <li class='user-footer'>
                        <div class='pull-left'>
                          <a href='".base_url()."index.php/Contador/mi_perfil' class='btn btn-default btn-flat'>Perfil</a>
                        </div>
                        <div class='pull-right'>
                          <a href='".base_url()."index.php/Login' class='btn btn-default btn-flat'>Cerrar Sesion</a>
                        </div>
    ...
    public static function getHeaderTransportista($nombre,$apellido,$fecha_registro,$foto_perfil)
    {
        $html=
        "
          <header class='main-header'>
            <!-- Logo -->
            <a href='".base_url()."index.php/Transportista/index' class='logo'>
              <!-- mini logo for sidebar mini 50x50 pixels -->
              <span class='logo-mini'>ADM</span>
              <!-- logo for regular state and mobile devices -->
              <span class='logo-lg'>".Header_usuario::$texto_header."</span>
              ...
              <div class='navbar-custom-menu'>
                ...
                $html.="<span class='hidden-xs'>".$nombre." ".$apellido."</span>
                    ...
                    else
                    {
                      ...
                      <li class='user-footer'>
                        <div class='pull-left'>
                          <a href='".base_url()."index.php/Transportista/mi_perfil' class='btn btn-default btn-flat'>Perfil</a>
                        </div>
                        <div class='pull-right'>
                          <a href='".base_url()."index.php/Login' class='btn btn-default btn-flat'>Cerrar Sesion</a>
                        </div>
